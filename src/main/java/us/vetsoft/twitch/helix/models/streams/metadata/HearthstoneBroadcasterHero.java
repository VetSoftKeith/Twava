...
public class HearthstoneBroadcasterHero {
    ...
    public HearthstoneBroadcasterHero withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public HearthstoneBroadcasterHero withHeroClass(String heroClass) {
        this.heroClass = heroClass;
        return this;
    }
    ...
    public HearthstoneBroadcasterHero withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof HearthstoneBroadcasterHero)) {
            return false;
        }
        HearthstoneBroadcasterHero rhs = ((HearthstoneBroadcasterHero) other);
